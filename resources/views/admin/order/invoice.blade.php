                    ...
                    <div class="col-lg-12">
                        <div class="invoice-box mb-5">
                            <table cellpadding="0" cellspacing="0">
                                ...
                                <tr class="total">
                                    <td colspan="4"></td>
                                    <td>Item Total: (<span>&#2547;</span>) {{$sum}}</td>
                                </tr>
                                <tr class="total">
                                    <td colspan="4"></td>
                                    <td>Tax Amount: (<span>&#2547;</span>) {{$order->tax_total}}</td>
                                </tr>
                                <tr class="total">
                                    <td colspan="4"></td>
                                    <td>Shipping Amount: (<span>&#2547;</span>) {{$order->shipping_total}}</td>
                                </tr>
                                <tr class="total">
                                    <td colspan="4"></td>
                                    <td>Total Payable: (<span>&#2547;</span>) {{$order->order_total}}</td>
                                </tr>
                            </table>
                        </div>
                    </div>
